...
function Header() {
  ...
  return (
    <AppBar position="static" elevation={0} sx={{ background: palette.bg, borderBottom: `2px solid ${palette.border}`, color: palette.text, boxShadow: '0 2px 8px 0 #e0c9b3', borderRadius: 0 }}>
      <Toolbar sx={{ justifyContent: 'space-between', minHeight: 72, px: 2 }}>
        {/* Left: Logo/Title */}
        <Typography variant="h5" fontWeight={700} sx={{ color: palette.accent2, letterSpacing: 1, fontFamily: 'serif', pl: 1 }}>
          RideShare
        </Typography>
          ...
          <Box>
            <IconButton onClick={handleMenuOpen} size="large">
              <Avatar
                ...
                sx={{ bgcolor: palette.accent2, width: 44, height: 44, fontFamily: 'serif', fontWeight: 700 }}
              >
